...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e19]:
      ...
      - generic [ref=e23]: 1 / 12 families · Variant 2 / 5
      - button "← Prev Variant" [ref=e24] [cursor=pointer]
      - button "Next Variant →" [ref=e25] [cursor=pointer]
    - generic [ref=e29]:
      - img "Hero image" [ref=e36]
      - heading "FlowRunner orchestrates rich, image-led screens" [level=1] [ref=e38]
      - heading "AI-generated hero art drives the entire visual identity." [level=2] [ref=e40]
      - button "Generate next screen" [ref=e42] [cursor=pointer]
  - alert [ref=e43]
```