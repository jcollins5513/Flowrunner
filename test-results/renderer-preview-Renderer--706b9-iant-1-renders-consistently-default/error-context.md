  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - generic [ref=e4]:
        ...
        - combobox [ref=e6]:
          - option "ONB HERO TOP"
          - option "FEAT IMAGE TEXT RIGHT" [selected]
    ...
    - generic [ref=e19]:
      - button "← Prev Family" [ref=e20] [cursor=pointer]
      - button "Next Family →" [ref=e21] [cursor=pointer]
      - generic [ref=e23]: 2 / 12 families · Variant 1 / 5
      - button "← Prev Variant" [disabled] [ref=e24]
    ...
    - generic [ref=e29]:
      ...
      - paragraph [ref=e39]: Compose multi-screen flows with deterministic patterns and reusable image systems.
      - button "Generate next screen" [ref=e41] [cursor=pointer]
  - alert [ref=e42]
```